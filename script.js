...
btnLogin.addEventListener('click', async () => {
    ...
    btnLogin.innerText = "AUTENTIKASI...";
    btnLogin.style.backgroundColor = "#9ca3af";

    try {
        const payloadLogin = { action: "login", username: user, password: pass };
        
        const response = await fetch('https://script.google.com/macros/s/AKfycbzs5n8cxADFKX9HQ6rSKXcURCQsblhTaPIcZyvfNe-vg6NolL0onNls9cheUvthsNVh/exec', { 
            method: 'POST', 
...
async function prosesPembayaran() {
    ...
    try {
        const response = await fetch('https://script.google.com/macros/s/AKfycbzs5n8cxADFKX9HQ6rSKXcURCQsblhTaPIcZyvfNe-vg6NolL0onNls9cheUvthsNVh/exec', { method: 'POST', body: JSON.stringify(dataTransaksi) });
        const result = await response.json();
...
btnSimpanProduk.addEventListener('click', async () => {
    ...
    try {
        const response = await fetch('https://script.google.com/macros/s/AKfycbzs5n8cxADFKX9HQ6rSKXcURCQsblhTaPIcZyvfNe-vg6NolL0onNls9cheUvthsNVh/exec', { method: 'POST', body: JSON.stringify(payloadProduk) });
        const result = await response.json();
...
if (btnLaporan) {
    btnLaporan.addEventListener('click', async () => {
        ...
        try {
            ...
            // Fetch ke server (Tetap biarkan 'https://script.google.com/macros/s/AKfycby0bN7WR4vsfBUojoK_9gGJc4hgYGv8Rr3zhaHKbO-qx8puwm7ZgqGA3Gom8jTrTsvgiw/exec' karena di Bos bisa jalan)
            const response = await fetch('https://script.google.com/macros/s/AKfycbzs5n8cxADFKX9HQ6rSKXcURCQsblhTaPIcZyvfNe-vg6NolL0onNls9cheUvthsNVh/exec', { 
                method: 'POST', 
